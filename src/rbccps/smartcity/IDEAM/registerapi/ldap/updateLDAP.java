...
public class updateLDAP {
	...
	public static String deleteEntry(String entityID,String x_Consumer_Custom_ID) 
	{
		// TODO Auto-generated method stub
		...
		int ldap_code=LDAP.deleteEntry(entityID, x_Consumer_Custom_ID);
		
		if (ldap_code==1||ldap_code==-1) {
