...
public class addEntryToLDAP {
	...
	public boolean addEntry(String providerId, String userId, String apiKey) {
		...
		String brokerExchange_DeviceName_EntryDN = "description=" + userId
		...
		String brokerExchange_DeviceName_Configure_EntryDN = "description="
				+ userId
		...
		String brokerQueueEntryDN = "description=queue,description=broker,"
				+ "uid=" + userId + ",cn=devices,dc=smartcity";
		...
		String brokerQueue_Name_EntryDN = "description=" + userId
